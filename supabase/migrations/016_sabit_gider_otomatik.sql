-- ============================================================
-- PilotGarage — 016: Sabit giderler skip Onay (owner request 2026-07-10)
-- Fixed expenses are pre-approved by definition: the daily materializer
-- now creates them born ONAYLANDI (like maaş/avans) — they hit the kasa
-- immediately instead of waiting in the Onay queue.
-- ============================================================
